...
des_encrypt_parser.add_argument(
    "mode",
    required=True,
    type=str,
...
des_encrypt_parser.add_argument("iv", type=str, help="initialization vector.")
...
des_decrypt_parser.add_argument(
    "mode",
    required=True,
    type=str,
    choices=allowed_modes,
...
des_decrypt_parser.add_argument("iv", type=str, help="initialization vector.")
des_decrypt_parser.add_argument(
    "encrypted_message",
    required=True,
    type=str,
